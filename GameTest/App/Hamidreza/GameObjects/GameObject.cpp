...
void GameObject::SetColorA(Color color)
{
    m_colorA = color;
}

void GameObject::SetColorB(Color color)
{
    m_colorA;
}

Color GameObject::GetColorB()
{
    return m_colorB;
}

Color GameObject::GetColorA()
{
    return m_colorA;
}
...
Color GameObject::GetMeshSegmentColor(unsigned int index, unsigned int vertCount)
{
    ...
    return Color::Interpolate(m_colorA, m_colorB, factor);
}
